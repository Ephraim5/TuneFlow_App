...
import { ArtistStyle } from './Artist/ArtistStyle';
      ...
      return (
        <GestureHandlerRootView style={{ flex: 1 }}>
          <BottomSheetModalProvider >
            <LinearGradient colors={['gray', '#000', '#000']}
              start={{ x: 1, y: 0 }}
              end={{ x: 1, y: 0.6 }}
                ...
                ListHeaderComponent={
                  <>
                    <View style={ArtistStyle.header}>
                      ...
                      <Text style={{ color: "white", fontSize: 20, fontFamily: 'Poppins-Bold', textTransform: "uppercase" }}>{title == null || title == '' ? "Listen To Music" : title}</Text>
